...
export default function (Z) {
              ...
              switch (g = charCodeAt(e, l)) {
                ...
                case 47:
                  switch (g = charCodeAt(e, l + 1)) {
                    ...
                    case 47:
                      a: {
                        for (u = l + 1; u < H; ++u) switch (charCodeAt(e, u)) {
                          case 47:
  ...
  function aa(d, c, e) {
    ...
    switch (m) {
      ...
      case 1:
        ...
        for (d = 0 === m ? '' : d[0] + ' '; b < a; ++b) c[b] = ca(d, c[b], e, m).trim();
      ...
      default:
        ...
        for (c = []; b < a; ++b) for (var n = 0; n < m; ++n) c[v++] = ca(d[n] + ' ', h[b], e, m).trim();
  ...
  function F(d, c, e, h, a, m, b, v, n, q) {
    for (var g = 0, w = c, E; g < A; ++g) switch (E = V[g].call(K, d, w, e, h, a, m, b, v, n, q)) {
      case void 0:
      case !1:
      case !0:
      case null:
  ...
  function W(d) {
    switch (d) {
      ...
      default:
        if ('function' === typeof d) V[A++] = d;else if ('object' === typeof d) for (var c = 0, e = d.length; c < e; ++c) W(d[c]);else ba = !!d | 0;
    }
