...
var _unitless = /*#__PURE__*/_interopRequireDefault( /*#__PURE__*/require("@dash-ui/unitless"));

var _createDash = /*#__PURE__*/require("./create-dash");
...
function createStyles(options = {}) {
  const dash = options.dash || (0, _createDash.createDash)();
  const {
    key,
    insert,
    sheets
  ...
  const themes = {};
  const tokens = {};
  const hash = (0, _utils.safeHash)(key, options.hash || _utils.hash);
...
function stringifyStyleObject(object) {
  ...
  for (const key in object) {
    ...
    if (typeof value !== "object") {
      ...
      string += (isCustom ? key : cssCase(key)) + ":" + (typeof value !== "number" || _unitless.default[key] || value === 0 || isCustom ? value : value + "px") + ";";
    } else {
...
const mangled = /*#__PURE__*/(0, _utils.safeHash)("", _utils.hash);
...
const styles = /*#__PURE__*/createStyles();
/**
